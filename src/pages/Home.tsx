  ...
  return (
    <div className="pb-32 px-6 pt-16">
      ...
      <div className="grid grid-cols-2 gap-4 mb-12">
        ...
        <Link to="/wishlist" className="glass-panel p-6 flex flex-col items-center text-center">
          <Heart className="text-[var(--accent-blue)] mb-2" size={24} />
          <span className="text-[10px] font-black uppercase">Wishlist</span>
        </Link>
        <Link to="/catalog" className="glass-panel p-6 flex flex-col items-center text-center">
